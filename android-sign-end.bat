...
PSCP.EXE -scp -pw ubnt VAN-SE_Android_Config.cfg ubnt@192.168.1.20:/tmp/VAN-SE_Android_Config.cfg
...
plink -ssh -pw ubnt ubnt@192.168.1.20 "cat /tmp/VAN-SE_Android_Config.cfg > /tmp/system.cfg"
